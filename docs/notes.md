# Working Notes (human-owned; agents read-only after initial seed)
...
## Objects
- Borrowed helmet  
- Small headlamp with weak batteries  
- Coffee thermos on dashboard  
- Rope coiled but unused  

## Leads or Hunches
- The contrast between lightness and duty, climbing followed by work  
- How repetition makes confidence seem effortless  
- How fast learning feels in the mountains before risk catches up  
- The absence of glamour. Ordinary gear, cheap gloves, long drives  
- The story should end where detail equals silence, not grief, just quiet  

## Voice Reminders
- Keep language restrained and observational  
- Avoid explaining motives  
- Let sensory detail carry meaning  
